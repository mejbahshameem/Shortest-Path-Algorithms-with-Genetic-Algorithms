function modified_ga_new(no_of_vertices,psize,src,dest,edge_start, edge_connected, edge_weight,edges,G,max)
...
for i=1:psize
  ...
  while(t<max)
       ...
       pm=mutation_new(p,psize,src,dest,no_of_vertices);
